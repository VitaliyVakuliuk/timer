(function () {
    ...
    Timer.prototype.updateLapsContainer = function () {
        ...
        function updateLaps(laps) {
            let lapInfo = document.createElement('div');
    ...
    Timer.prototype.closeThisLap = function (event) {
        if (event.target !== null && event.target.classList.contains('label-danger')) {
            let allLaps = document.querySelectorAll('.alert-info');
            let lapIndexToRemove = Array.prototype.indexOf.call(allLaps, event.target.parentNode);
    ...
    Timer.prototype.formatTime = function (miliseconds) {
        let mili = parseInt((miliseconds) % 1000);
    ...
    Timer.prototype.timerMarkUp = function () {
        ...
        let stopwatchControls = document.createElement('div');
    ...
    let timer1 = document.querySelector('.timer-first');
    window.timer1 = new Timer(timer1);

    let timer2 = document.querySelector('.timer-second');
